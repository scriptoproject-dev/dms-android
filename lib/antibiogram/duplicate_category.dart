// import 'dart:async';
// import 'package:amsp_flutter/antibiogram/antibiogram_api_services.dart';
// import 'package:amsp_flutter/antibiogram/antibiogram_list_screen.dart';
// import 'package:amsp_flutter/antibiogram/antibiogram_post_service.dart';
// import 'package:amsp_flutter/antibiogram/database_helper_antibiogram.dart';
// import 'package:amsp_flutter/constants/colors.dart';
// import 'package:amsp_flutter/constants/strings.dart';
// import 'package:amsp_flutter/home/home_screen.dart';
...
//     setState(() {
//       this.antibiogramIds = antibiogramIds;
//     });

//     debugPrint('Fetched Antibiogram IDs: $antibiogramIds');
...
//                     // Call API for Gram Positive only if it hasn't been called yet
//                     // await postAntibiogramData("gram positive");
//                     setState(() {
//                       isGramPositiveAPICalled = true;
//                     });
//                   } else if (index == 1 && !isGramNegativeAPICalled) {
//                     // Call API for Gram Negative if it hasn't been called yet
...
//                               color: gray, // Optional: Tint the image if needed
//                             ),
//                           ],
//                         ),
//                       ),
...
//           decoration: BoxDecoration(
//             color: color,
//             borderRadius: BorderRadius.circular(4), // Rounded square shape
//           ),
//         ),
...
//                 // Filter the data list for the current y_axis_name
...
//                             dataList: filteredData, // Pass the filtered data
//                           ),
//                         ),
//                     ],
//                   ),
...
//     const double tileHeight = 56.0; // Approximate height of each ListTile
...
//                               // If category_id is not empty, update selectedCategoryId and fetch data
//                               if (selectedCategoryId.isNotEmpty) {
//                                 setState(() {
//                                   this.selectedCategoryId =
//                                       selectedCategoryId; // Update the selectedCategoryId
//                                 });
//                                 debugPrint(
//                                     "Updated selected category ID: $selectedCategoryId");
//                                 fetchAntibiogramIds();
//                               }
